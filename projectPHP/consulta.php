                        ...
                        <table class="table table-secondary table-striped-columns">
                            ...
                            <tbody>
                                ...
                                if (isset($_POST['id']) && isset($_POST['nome']) && isset($_POST['endereco']) && isset($_POST['bairro']) && isset($_POST['cep']) && isset($_POST['cidade']) && isset($_POST['estado'])) {
                                    ...
                                    $query = "UPDATE cadastro SET nome='$nome', endereco='$endereco', bairro='$bairro', cep='$cep', cidade='$cidade', estado='$estado' WHERE id=$id";
                                ...
                                if (mysqli_num_rows($result) > 0) {
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        echo "<td><a href='editar.php?id=" . $row['id'] . "' class='btn btn-outline-dark'>Editar</a></td>";
                                        echo "</tr>";
                                    }
                                } else {
